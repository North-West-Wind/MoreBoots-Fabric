...
public class BlockInit {
    ...
    public static final Block VISCOUS_GOO = new ViscousLayerBlock(AbstractBlock.Settings.of(Material.COBWEB).ticksRandomly().noCollision().strength(0.1f).sounds(BlockSoundGroup.SLIME).blockVision((state, level, pos) -> state.get(ViscousLayerBlock.LAYERS) >= 8));
    ...
    public static void registerBlocks() {
        ...
        register("viscous_goo", VISCOUS_GOO, null);
